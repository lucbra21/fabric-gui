...
DESCRIPCIONES_ES = {
    ...
    "analyse_claims": "Analiza y califica afirmaciones con evidencias y contraargumentos",
    "analyse_comments": "Evalúa comentarios de internet y categoriza su sentimiento",
    "analyse_debate": "Califica debates y proporciona análisis imparcial de argumentos",
    "analyse_email_headers": "Analiza cabeceras de email para detección de amenazas",
    "analyse_incident": "Extrae detalles clave de informes de brechas de ciberseguridad",
    "analyse_interviewer_techniques": "Analiza técnicas de entrevistadores e identifica cualidades únicas",
    "analyse_logs": "Analiza archivos de registro para identificar patrones y anomalías",
    "analyse_malware": "Analiza detalles de malware y extrae indicadores clave",
    "analyse_military_strategy": "Analiza batallas históricas y ofrece perspectivas estratégicas",
    "analyse_mistakes": "Analiza errores pasados en patrones de pensamiento y mejora predicciones",
    "analyse_paper": "Analiza papers de investigación evaluando rigor y calidad",
    "analyse_patent": "Analiza patentes detallando campo, problema, solución y novedad",
